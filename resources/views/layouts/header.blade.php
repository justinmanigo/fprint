...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/img/logo.png') }}" width="40" height="40" class="d-inline-block align-top rounded" alt="">
    <title>Falcon Printing Service</title>
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'Fprint') }}</title>
